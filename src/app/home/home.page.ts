...
export class HomePage {
  ...
  constructor(private alertController: AlertController,private serviceCall:ApiService,private modalCtrl: ModalController,private http: HttpClient,private modelctrl: ModalController, private router: Router, private route: ActivatedRoute) {
